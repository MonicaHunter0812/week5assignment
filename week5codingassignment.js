...
class Menu {
    ...
    createClub() {
        let name = prompt('Please enter the name of the club:'); 
        this.clubs.push(new Club(name)); 
    }

    viewClub() {
        let index = prompt('Please enter the number of the club you would like to view:');
    ...
    deleteClub() {
        let index = prompt('Please enter the number of the club you you would like to delete:'); 
    ...
    createStudent() {
        ...
        let grade = prompt('Please add the grade level of the new student:');
        this.selectedClub.students.push(new Student(name, role, grade));
    }

    deleteStudent() {
        let index = prompt('Please enter the number of the student you would like to delete:');
